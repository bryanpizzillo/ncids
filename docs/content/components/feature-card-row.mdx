			...
			<a href="https://www.cancer.gov" aria-label="Feature Card">
				...
				<div class="nci-feature-card__text">
					...
					<p>
						...
						severe COVID-19 with interferons, a type of protein that can help
						the body’s immune system fight infections, decreased the viral load
...
@import '@nciocpl/ncids-css/scss/components/nci-feature-card/nci-feature-card';
```
